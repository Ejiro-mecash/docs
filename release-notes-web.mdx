...
<AccordionGroup>
  <Accordion title="February 2026 — Web App Release (Status: Live)">
    **New Features & Enhancements**
    ...
    - **Moolahgo Payouts**: Configured new payout routes for Singapore (SGD), Vietnam (VND), Malaysia (MYR), Thailand (THB), and South Korea (KRW) via Moolahgo.
    - **USD Payouts Enhancements**: Added an optional Intermediary Bank SWIFT Code text box for USD payouts.

    **Form & Input Validations**

    - Implemented a 25-character limit validation on the `bene_nickname` field for all Moolahgo routes.
    ...
    **UI/UX Fixes**
    ...
    - Fixed a 404 error state when updating webhook URLs in the developers' module.
  </Accordion>
