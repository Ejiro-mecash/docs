...
<Accordion title="August 2026 — Web App Release (Status: Live)">
  **New Features**

  - **USD wallets**: Added support for USD wallet capabilities.
  - **EUR wallets**: Added the ability to create EUR wallets manually.
  - **Address book**: Added the ability to save sender information for easier future transactions.
  - **Login security**: Added CAPTCHA protection to the production login experience.

  **Enhancements**

  - **Wallet availability**: The wallet page now displays only currencies/countries where wallet capabilities are available, and clearly indicates whether a wallet is instant.
  - **Wallet requests**: Wallets requested or already added are no longer shown as available options when adding a new wallet.
  - **Wallet creation**: Improved the wallet creation experience with automated wallet creation.
  - **Payout experience**: Redesigned the POBO payout flow for a smoother experience.
  - **EUR payouts**: Standardized EUR payout information to provide a more consistent experience.
  - **Moolahgo payouts**: Updated Moolahgo wallet payout fields to align with the standard payout experience.
  - **Bank details**: Improved handling and display of destination bank country information for bank transfers and SWIFT payments.
  - **Sender information**: Improved consistency of sender information across different payout routes.
  - **Transaction confirmation**: Added bank country information to the transaction confirmation page.
  - **Validation**: Improved transaction validation messages to provide clearer information about recipient amount limits.
  - **GBP Pay by Bank**: Improved the GBP Pay by Bank experience and fixed issues with country information.
  - **Payment remarks**: Improved invoice upload handling for NGN-NGN payment remarks.
  - **Ramp**: Updated the Ramp experience to provide a more streamlined, token-based transaction flow.
  - **Error handling**: Improved the consistency and presentation of validation and error messages across the platform.
  - **Branding**: Updated website references from Swype Visa Cards to Swype Mastercard.

  **Bug Fixes**

  - Fixed issues affecting the display of GBP and CNY wallet details.
  - Fixed currency flag display issues across supported wallets.
  - Fixed an issue where NGN was incorrectly displayed as a funding currency for TZS wallets.
  - Fixed missing GBP beneficiary information.
  - Fixed incorrect sender information on transaction confirmation screens.
  - Fixed payment status updates for NGN to GBP transactions.
  - Fixed an issue that could prevent customers from completing KYB due to validation errors.
</Accordion>

<Accordion title="July 2026 — Web App Release (Status: Live)">
  **New Features**

  - **USD wallets**: USD wallets are now available for customers to hold and manage US Dollar funds.
  - **EUR wallets**: Added support for creating EUR wallets through the web dashboard.
  - **eSIM services**: Added support for eSIM services to the web experience.

  **Enhancements**

  - **Wallet visibility**: Customers can manage which wallets are displayed on their dashboard.
  - **Wallet display**: Improved the presentation of active wallets across the dashboard.
  - **USD funding**: Improved access to USD wallet funding information.
  - **Destination country**: Customers can now select a recipient's destination country when creating a new recipient.
  - **Account Number & IBAN**: Recipient forms now allow customers to provide either an account number or an IBAN rather than requiring both.
  - **EUR payouts**: Standardized the EUR payout experience to provide a more consistent recipient details flow.
  - **POBO payouts**: Redesigned the POBO payout experience for a smoother transfer journey.
  - **Payout progress**: Improved progress indicators throughout the Send Money flow.
  - **Recipient management**: Improved the recipient experience, including saved recipient information.
  - **Ramp experience**: Updated the Ramp flow to make token selection more intuitive before choosing the supported network.
  - **Crypto transfer warnings**: Improved the visibility of crypto transfer warnings with clearer alert styling.
  - **Payment links**: Removed meCash branding from payment link pages, allowing merchants to provide a more fully branded payment experience.
  - **Swype Mastercard**: Updated website card visuals to reflect the current Swype Mastercard offering.

  **Bug Fixes**

  - Fixed an issue where EUR wallet account details were not displayed correctly.
  - Fixed discrepancies in payment amounts displayed across the dashboard.
  - Fixed an issue that could leave EUR transactions stuck at the Payment Received stage.
</Accordion>
