---
title: "Get Quote (Crypto)"
openapi: get /v1/ramp/quote/{quoteId}
---
...
<Tip>
  **New to the Ramp API?** Read [How meCash Ramp Works](/ramp-docs/about-ramp) for the full lifecycle and integration considerations. See [Supported Assets & Destinations](/ramp-docs/supported-assets) for the complete token and network reference.
</Tip>
