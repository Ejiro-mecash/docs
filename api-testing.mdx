...
```bash
curl -X GET "https://sandbox.api.me-cash.com/v1/wallets" \
  -H "x-api-key: YOUR_SANDBOX_API_KEY"
```
...
```bash
curl -X POST "https://sandboxapi.me-cash.com/v1/payouts" \
  -H "x-api-key: YOUR_SANDBOX_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "amount": "100.00",
...
export MECASH_PRODUCTION_API_KEY="your_production_api_key_here"
export MECASH_SANDBOX_URL="https://sandbox.api.me-cash.com"
export MECASH_PRODUCTION_URL="https://api.me-cash.com"
```
...
curl -X GET "$MECASH_PRODUCTION_URL/v1/wallets" \
  -H "x-api-key: $MECASH_PRODUCTION_API_KEY"
```
