...
<Info>
When you include `"remark": "failed"` in your payout request, the system will process the payout as a failure and send a `payout.failed` webhook to your configured webhook URL. This allows you to test your failure handling logic without real transactions.
</Info>

### Expected Webhook Response

After submitting a payout with `"remark": "failed"`, you will receive a `payout.failed` webhook event:
