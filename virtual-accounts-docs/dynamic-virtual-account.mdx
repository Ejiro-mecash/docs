...
| data.status | string | Virtual account status |
| data.currency | string | Currency code (NGN) |
| data.country | string | Country code (NG) |
| data.isPermanent | boolean | Value for virtual account type. 'ACTIVE' for Dynamic Virtual Accounts , 'INACTIVE' for Static Virtual Accounts |
