...
```bash cURL
curl --request POST 'https://{{baseURL}}/v1/bulk/payout' \
  --header 'Content-Type: application/json' \
  --header 'x-api-key: YOUR_API_KEY' \
  --data '{
    "orders": [
...
| **Quote expiry** | [Bulk quotes](/quote-docs/bulk-quote) expire after 10 minutes. Submit your payout promptly after quoting. |
