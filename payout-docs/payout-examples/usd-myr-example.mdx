...
This endpoint allows you to process payouts in **Malaysian Ringgit (MYR)** to recipients with a bank account in Malaysia, funded from a **US Dollar (USD)** balance.
