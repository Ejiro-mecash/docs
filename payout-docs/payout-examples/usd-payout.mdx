...
| `data.sender`                      | Object | An object containing details about the sender.                  |
| `data.sender.name`                 | String | The full name of the sender or business.                        |
| `data.sender.icNumber`             | String | The sender's masked identification/IC number.                   |
| `data.sender.nationality`          | String | The sender's two-letter ISO nationality code.                   |
| `data.sender.address.line1`        | String | The first line of the sender's address.                         |
| `data.sender.mobileNumber`         | String | The sender's masked mobile number.                              |
| `data.sender.occupation`           | String | The sender's occupation or industry.                            |
