...
This endpoint allows you to process payouts in **Singapore Dollars (SGD)** to recipients with a bank account in Singapore, funded from a **US Dollar (USD)** balance.
...
--data '{
  ...
  "quoteId": "usd-sgd-quote-id-sample",
  "reason": "Gift",
  "remark": "Testing"
}'
```
