...
| `recipient.account.intermediarySwiftCode` | String | The SWIFT/BIC code of the intermediary bank. | ❔ No (Conditional) |
...
![Intermediary Bank Field Reference](/public/images/intermediary-bank-ui.png)
...
<AccordionGroup>
  <Accordion title="What happens if the intermediary SWIFT code is missing?">
  ...
  <Accordion title="What happens if the wrong code is provided?">
  ...
  <Accordion title="Does every USD SWIFT transfer require an intermediary bank?">
