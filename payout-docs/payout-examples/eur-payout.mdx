...
| `SWIFT_CUSTOMER` | The sending customer bears all SWIFT transfer charges. |
...
| :---------------------------------- | :------ | :-------------------------------------------------------------------------- | :------- |
| `paymentChannel`                    | String  | The payment method. E.g., `BANK_TRANSFER`, `SWIFT_SHARED`, `SWIFT_CUSTOMER`. | ✅ Yes   |
