...
This endpoint allows users to **send payouts in Malawian Kwacha (MWK)** to recipients in **Malawi**.
...
| `recipient.currency`              | String  | `MWK` (Malawian kwacha)                             | ✅ Yes   |
| `recipient.country`               | String  | `MW` (Malawi)                                      | ✅ Yes   |
