---
title: 'Ramp Payout'
description: 'Execute a ramp transaction (crypto-to-crypto, offramp to bank, or onramp to wallet) by using the quoteId.'
icon: paper-plane
---
...
curl --request POST '{{baseURL}}/v2/ramp/payout' \
  ...
  --data '{
    ...
    "quoteId": "108e2f2d-be85-4a49-93c8-xxxxxxxxxxxx",
    "reason": "Gift",
    "remark": "Checking"
  }'
```
