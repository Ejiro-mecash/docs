...
- Pass the `quoteId` to [`POST /v2/payout`](/payout-docs/create-payout) to execute the transfer.
- For multiple recipients, use the [`Bulk Quote API`](/quote-docs/bulk-quote) to quote all amounts in one request.
