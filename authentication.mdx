...
```md
![developer section](images/Screenshot100106.png) 
```
...
```md
![api key generated](images/Screenshot084315.png)
```
...
```md
![Delete API Key](images/Screenshot091543.png) 
```

6. In the confirmation pop-up, click **Confirm**.  
```md
![Confirm deletion](images/Screenshot091600.png)  
```
...
```md
![OTP verification](images/Screenshot091611.png)  
```
