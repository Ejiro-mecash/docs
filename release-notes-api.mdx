...
<AccordionGroup>
  <Accordion title="May 2026 — Version v1.x (Status: Live)">
    ...
    **Action needed:** Update your payout request payloads to use `SWIFT_CUSTOMER`, `SWIFT_SHARED`, or `SWIFT_BENEFICIARY` in place of the deprecated `SWIFT` value. No other fields change — recipient account details, sender details, and quote request format remain identical.
  </Accordion>
